          ...
          <div id="carouselExample" class="carousel slide">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="./Imagenes/Teleferico.jpg" class="d-block w-100 h-70" alt="Caracas">
              </div>
              <div class="carousel-item">
                <img src="./Imagenes/Caracas.webp" class="d-block w-100 h-70" alt="Zulia">
              </div>
            </div>
